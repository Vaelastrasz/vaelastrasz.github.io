data_action = [
    {
        title: "Атака",
        icon: "crossed-swords",
        subtitle: "Ближняя/дальняя атака",
    ...
    },
    {
        ...
        icon: "snatch",
        subtitle: "Используйте окружение",
        description: "Используйте окружение",
        reference: "Adventurer's Guide, pg. 444",
        bullets: [
    ...
    },
    {
        ...
        icon: "round-shield",
        subtitle: "Возьмите/спрячьте щит",
        description: "Возьмите/спрячьте щит",
    ...
    },
    {
        ...
        icon: "first-aid",
        subtitle: "Окажите первую помощь",
