data_condition = [
    ...
    },
    {
        ...
        reference: "Adventurer's Guide, pg. 617.",
        bullets: [
            "Парализованное существо недееспособно, оно не может двигаться и говорить.",
            ...
            "Любая атака, что нанесена по парализованному существу, является критической, если атакующий находится в пределах 5 футов от цели."
        ]
    },
    {
        title: "Окаменел",
    ...
    },
    {
        ...
        bullets: [
            ...
            "Существо без сознания бросает всё, что держит, и падает ничком.",
