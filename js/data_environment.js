...
data_environment_light = [
    ...
    },
    {
        ...
        description: "Также называемая тенью",
        reference: "Adventurer's Guide, pg. 421.",
        bullets: [
...
data_environment_vision = [
    {
        ...
        bullets: [
            ...
            "Поговаривают, что существа, что не полагаются на визуальные сигналы, имеют слепое зрение, и имунны к визуальным иллюзиям (как те, что создаёт <i>Малая иллюзия</i>)."
        ]
    },
    {
        title: "Тёмное зрение",
